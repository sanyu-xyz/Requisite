                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="manufacturer_top" value="yes" <?php if ($m_top == 'yes') echo "checked='checked'"; ?> required>
                                <label> Yes </label>
                                <input type="radio" name="manufacturer_top" value="no" <?php if ($m_top == 'no') echo "checked='checked'"; ?> required>
                                <label> No </label>
                            </div>
                        </div>
                        <div class="form-group">
