...
<div class="footer-nav">
  <div class="container clearfix">
    ...
    <div class="footer-nav__col footer-nav__col--info">
      ...
      <ul class="footer-nav__list">
        <li class="footer-nav__item">
          <a href="../shop.php" class="footer-nav__link">View Products</a>
        </li>
        <li class="footer-nav__item">
    ...
    <div class="footer-nav__col footer-nav__col--account">
      ...
      <ul class="footer-nav__list">
        <li class="footer-nav__item">
          <a href="./my_account.php?my_orders" class="footer-nav__link">Profile</a>
        </li>
        <li class="footer-nav__item">
    ...
    <div class="footer-nav__col footer-nav__col--contacts">
      ...
      <div class="email">
        Email:
        <a href="mailto:support@requisite.com" class="email__addr">support@requisite.com</a>
      </div>
    </div>
...
<div class="page-footer__subline">
  <div class="container clearfix">
    <div class="copyright">
      &copy; <?php echo date("Y"); ?> RequiSite&trade; - All Rights Reserved
    </div>
  </div>
</div>
