...
?>
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="submit" name="submit" value="Insert Admin User" class="btn btn-primary form-control">
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($run_admin) {
            ...
            echo "<script>alert('Admin User account has been inserted successfully')</script>";
