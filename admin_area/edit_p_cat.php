                ...
                <div class="panel-body">
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="p_cat_top" value="yes" <?php if ($p_cat_top == 'yes') echo "checked='checked'"; ?> required>
                                <label> Yes </label>
                                <input type="radio" name="p_cat_top" value="no" <?php if ($p_cat_top == 'no') echo "checked='checked'"; ?> required>
                                <label> No </label>
                            </div>
                        </div>
                        <div class="form-group">
